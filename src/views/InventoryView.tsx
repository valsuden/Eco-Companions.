...
export function InventoryView({
  ...
  return (
    <div
      id="inventory-view"
      className="w-full h-full overflow-y-auto p-3 sm:p-6 select-none "
      style={{
      ...
      <div className="max-w-5xl mx-auto space-y-5 pb-24 md:pb-8">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold transition-all shadow-md active:scale-95 cursor-pointer self-start sm:self-auto border"
            style={{
        ...
        <div
          className="grid grid-cols-2 p-1 rounded-2xl border shadow-inner max-w-md mx-auto"
          style={{
            backgroundColor: 'var(--surface)',
        ...
        >
          <button
            ...
            className={`flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-black transition-all cursor-pointer ${
              activeTab === 'wardrobe' ? 'shadow-md scale-[1.02]' : 'opacity-70 hover:opacity-100'
            }`}
            style={{
              backgroundColor: activeTab === 'wardrobe' ? 'var(--accent)' : 'transparent',
              color: activeTab === 'wardrobe' ? '#ffffff' : 'var(--text-secondary)',
            }}
          >
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-black transition-all cursor-pointer ${
              activeTab === 'backpack' ? 'shadow-md scale-[1.02]' : 'opacity-70 hover:opacity-100'
            }`}
            style={{
              backgroundColor: activeTab === 'backpack' ? 'var(--accent)' : 'transparent',
              color: activeTab === 'backpack' ? '#ffffff' : 'var(--text-secondary)',
            }}
          >
        ...
        {activeTab === 'wardrobe' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
            ...
            <div
              className="lg:col-span-5 rounded-3xl p-4 sm:p-5 border shadow-xl flex flex-col items-center justify-between relative overflow-hidden backdrop-blur-xl"
              style={{
                backgroundColor: 'var(--surface)',
                borderColor: 'var(--border)',
            ...
            >
              {/* Top Bar on Stage */}
              <div className="w-full flex items-center justify-between z-10 border-b pb-2 mb-2" style={{ borderColor: 'var(--border)' }}>
                <span className="text-[11px] font-black uppercase tracking-wider flex items-center gap-1.5" style={{ color: 'var(--accent)' }}>
                ...
                {(petInfo.equippedHat || petInfo.equippedGlasses || petInfo.equippedAccessory || petInfo.equippedAura) && (
                  <button
                    ...
                    className="flex items-center gap-1 text-[10px] font-bold px-2 py-1 rounded-lg border transition-all hover:opacity-80 cursor-pointer"
                    style={{
                      backgroundColor: 'var(--bg-primary)',
                      borderColor: 'var(--border)',
              ...
              <div className="w-full mt-3 grid grid-cols-2 gap-2 text-[10px] font-bold">
                <div
                  className="p-2 rounded-xl border flex items-center gap-2 truncate"
                  style={{
                    backgroundColor: 'var(--bg-primary)',
                    borderColor: petInfo.equippedHat ? 'var(--border-accent)' : 'var(--border)',
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: 'var(--bg-primary)',
                    borderColor: petInfo.equippedGlasses ? 'var(--border-accent)' : 'var(--border)',
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: 'var(--bg-primary)',
                    borderColor: petInfo.equippedAccessory ? 'var(--border-accent)' : 'var(--border)',
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: 'var(--bg-primary)',
                    borderColor: petInfo.equippedAura ? 'var(--border-accent)' : 'var(--border)',
                  }}
                >
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all cursor-pointer border ${
                        isSelected ? 'shadow-md scale-105' : 'hover:opacity-85'
                      }`}
                      style={{
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: isEquipped ? '0 0 12px var(--glow)' : 'none',
                          }}
                        >
                ...
                {filteredCosmetics.map((item) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="p-3 rounded-2xl border flex flex-col justify-between gap-2.5 transition-all relative overflow-hidden backdrop-blur-md"
                      style={{
                        backgroundColor: 'var(--surface)',
                        borderColor: isEquipped ? 'var(--border-accent)' : 'var(--border)',
                        boxShadow: isEquipped ? '0 0 14px var(--glow)' : 'var(--card-shadow)',
                      }}
                    >
                      <div className="flex items-start gap-3">
                        <div
                          className="w-11 h-11 rounded-xl flex items-center justify-center border shrink-0 shadow-sm"
                          style={{
                            backgroundColor: 'var(--bg-primary)',
                            borderColor: 'var(--border)',
                          }}
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <h3 className="text-xs font-extrabold truncate" style={{ color: 'var(--text-primary)' }}>
                              {item.name}
                            </h3>
                            <span className={`text-[8px] font-black uppercase px-1.5 py-0.2 rounded-full ${
                          ...
                          <p className="text-[10px] line-clamp-2 mt-0.5 leading-snug" style={{ color: 'var(--text-secondary)' }}>
                            {item.description}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-1 border-t" style={{ borderColor: 'var(--border)' }}>
                        <span className="text-[9.5px] font-semibold truncate max-w-[150px]" style={{ color: 'var(--accent)' }}>
                          {item.effectText}
                        </span>
        ...
        {activeTab === 'backpack' && (
          <div className="space-y-4">
            ...
            {filteredBackpack.length === 0 ? (
              <div
                className="p-8 sm:p-12 rounded-3xl border text-center space-y-3 backdrop-blur-xl"
                style={{
                  backgroundColor: 'var(--surface)',
                  borderColor: 'var(--border)',
                }}
              >
                <div
                  className="w-14 h-14 rounded-2xl mx-auto flex items-center justify-center border shadow-md"
                  style={{
                    backgroundColor: 'var(--bg-primary)',
                    borderColor: 'var(--border)',
                    color: 'var(--text-muted)',
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-black text-slate-950 shadow-md cursor-pointer transition-all active:scale-95"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5">
                {filteredBackpack.map((item) => (
                  <div
                    key={item.id}
                    className="p-3.5 rounded-2xl border flex flex-col justify-between gap-3 shadow-md backdrop-blur-md"
                    style={{
                      backgroundColor: 'var(--surface)',
                      borderColor: 'var(--border)',
                    }}
                  >
                    <div className="flex items-start gap-3">
                      <div
                        className="w-12 h-12 rounded-xl flex items-center justify-center border shrink-0 relative shadow-sm"
                        style={{
                          backgroundColor: 'var(--bg-primary)',
                          borderColor: 'var(--border)',
                        }}
                      >
                        ...
                        {item.qty > 1 && (
                          <span
                            className="absolute -top-1.5 -right-1.5 font-black text-[9px] px-1.5 py-0.2 rounded-full border shadow-sm"
                            style={{
                              backgroundColor: 'var(--accent)',
                              color: '#ffffff',
                              borderColor: 'var(--border-accent)',
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[10px] line-clamp-2 mt-0.5" style={{ color: 'var(--text-secondary)' }}>
                          {item.description}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-1 border-t" style={{ borderColor: 'var(--border)' }}>
                      ...
                      {item.category === 'food' ? (
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-black transition-all cursor-pointer shadow-md active:scale-95 border"
                          style={{
                            backgroundColor: 'var(--bg-primary)',
